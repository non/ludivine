  ...
  def cat
    ...
    def fact
        ...
        facts = [
            ...
            "A cat's purr may be a form of self-healing, as it can be a sign of nervousness as well as contentment.  Similarly, the frequency of a domestic cat's purr is the same at which muscles and bones repair themselves.",
            "Elderly cat owners suffer less from depression and loneliness than non-cat owners",
